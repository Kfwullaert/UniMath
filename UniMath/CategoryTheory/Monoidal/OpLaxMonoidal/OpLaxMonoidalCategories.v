...
Definition left_unitor : UU :=
  nat_trans (functor_identity C) I_pretensor.

Definition left_unitor_funclass (λ' : left_unitor):
  ∏ x : ob C, x --> I_pretensor x
  := pr1 λ'.
...
Definition associator : UU :=
  nat_trans assoc_right assoc_left.
