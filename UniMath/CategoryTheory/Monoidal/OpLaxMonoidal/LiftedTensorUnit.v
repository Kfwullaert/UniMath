...
Section LiftedUnit.
  ...
  Proof.
    exists (λ G GG, #(pr1 G) (identity _) · GG).
...
Section LiftedTensorUnit.
  ...
  Definition precomp_tensorunit_disp_functor
    :  disp_functor
         ...
         (OpLaxMonoidalFunctorCategory.functor_tensorunit_disp_cat TD TE ID IE)
         (OpLaxMonoidalFunctorCategory.functor_tensorunit_disp_cat TC TE I IE)
    := disp_prod_functor_over_fixed_base
         (HT Duniv H_eso H_ff TC TE) (HU I IE).

  Definition precomp_tensorunit_functor
    : functor (OpLaxMonoidalFunctorCategory.functor_tensorunit_cat TD TE ID IE)
              (OpLaxMonoidalFunctorCategory.functor_tensorunit_cat TC TE I IE).
  Proof.
    use total_functor.
  ...
  Lemma is_disp_univalent_functor_tensorunit_disp_cat
    : Univalence.is_univalent_disp (OpLaxMonoidalFunctorCategory.functor_tensorunit_disp_cat TD TE ID IE).
  Proof.
