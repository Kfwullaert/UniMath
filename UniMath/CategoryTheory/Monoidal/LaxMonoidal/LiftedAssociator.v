...
Require Import UniMath.CategoryTheory.Monoidal.LaxMonoidal.LiftedTensor.
Require Import UniMath.CategoryTheory.Monoidal.LaxMonoidal.LiftedTensorUnit.
...
Section RezkAssociator.
  ...
  Proof.
    set (t := lift_nat_trans_along_comm (_,,Duniv) _ HHH_eso HHH_ff
          (nat_trans_comp _ _ _ TransportedAssocLeft
                          (nat_trans_comp _ _ _
                             (post_whisker α H)
                             (nat_z_iso_inv TransportedAssocRight)
                          )
    ...
    - exact (nat_trans_comp_assoc (homset_property _)
              ...
              (post_whisker α H : functor_composite (assoc_left TC) H ⟹ functor_composite (assoc_right TC) H)
              (nat_z_iso_inv TransportedAssocRight)).
  Qed.
