(* In this file, we combine the results that any bicategory is weak biequivalent to a locally univalent bicategory and that any locally univalent bicategory is weak biequivalent to a global univalent bicategory.
*)
...
Require Import UniMath.Bicategories.Core.BicatToLocalUnivalentBicat.
...
Section RezkCompletionBicategory.
  ...
  Proof.
    ...
    - exact (weak_equivalence_to_' _ (pr222 r)).
  Defined.
